...
Route::get('/referentiel/type',[ReferentielController::class,'nbre'])->name('referentiel.type');
...
//Route::get('formation/delete($id)',[FormationController::class,'supprimer'])->name('sup');
